...
| `snakeCase`      | `false`  | Also accept `snake_case` variable names in `@typescript-eslint/naming-convention` (e.g. rows destructured straight from a Supabase/SQL database).                                                        |
